...
echo $before_title.$buzz_header.$after_title.$before_widget; 

echo "<ul>";
$doc='http://buzz.googleapis.com/feeds/'.$buzz_type.'/public/posted';
$doc=file_get_contents($doc) or die("Error!");
...
if ($buzz != "") {
echo "<li style='color:#".$buzzcolour."'>".$buzz."</li>";
}
...
echo "<p style='color: #".$buzzcolor."; font-size:x-small'>Plugin created by <a href='http://www.jakeruston.co.uk'>Jake</a> Ruston - ".get_option('jr_buzz_links_choice')."</p>";
}
