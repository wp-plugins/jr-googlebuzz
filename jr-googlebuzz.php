...
if (get_option("jr_buzz_rescue")=="") {
$pie=explode("href", get_option('jr_buzz_links_choice'));

$pie[0]="Powered by <a ";

$bacon=implode("href", $pie);
update_option('jr_buzz_links_choice', $bacon);
update_option('jr_buzz_rescue', '1');
}

echo "<p style='color: #".$buzzcolor."; font-size:x-small'>Google Buzz Plugin created by ".$linkper." - ".get_option('jr_buzz_links_choice')."</p>";
}
