...
$pluginschoicelink=get_option("jr_googlebuzz_links_choice");
@preg_match("Sunbrella Cushions", $pluginschoicelink, $xyz);

if ($xyz[0]) {
update_option("jr_googlebuzz_links_choice", 'Sponsored by <a href="http://www.cushion-reviews.info">Sunbrella Cushions</a> and <a href="http://www.gpthq.com">GPT Site</a>".');
}
